...
const mapsLink = "https://www.google.com/maps?q=Maniini+Thohoyandou"
const phone = "+27 76 959 6653"

// Use images not used on the first (CabalVilla) and second (Lumveleni) branch pages
const slides = [
	{ src: "/img1.jpeg", alt: "Cabal Maniini vibes" },
	{ src: "/img2.jpeg", alt: "Good times at Cabal Maniini" },
	{ src: "/mealsfor.jpeg", alt: "Meals for sharing" },
	{ src: "/jamason.jpeg", alt: "Premium drinks" },
]
				...
				<div className="grid lg:grid-cols-2 items-center gap-8">
					<div className="text-white text-center lg:text-left">
						...
						<h1 className="mb-4 text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-tight">
							Cabal
							<span className="block text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-rose-500 to-red-500">Maniini</span>
						</h1>
						<p className="text-base sm:text-lg lg:text-xl text-gray-100/90 mb-6 max-w-2xl mx-auto lg:mx-0">
							Experience great food, vibrant nightlife, and friendly service in the heart of Maniini, Thohoyandou.
						</p>
						<ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-xl mb-8 text-sm sm:text-base text-white/90">
							...
							<li className="flex items-center gap-2"><Car className="h-4 w-4 text-red-300"/> Nearby car care options</li>
					...
					<div className="mt-6 lg:mt-0">
						<div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
							<h3 className="font-semibold text-lg mb-4 text-white">Why Visit Cabal Maniini?</h3>
							<div className="space-y-4 text-sm">
								...
								<div className="flex items-start gap-3">
									...
									<div>
										<div className="font-medium text-white">Convenient Location</div>
										<div className="text-white/80 text-xs">Easy access in Maniini with ample space</div>
									</div>
								</div>
							</div>
						</div>
...
export default function CabalManiiniBranchPage() {
	const menuItems = [
	...
	return (
		<main className="min-h-screen">
				...
				<div className="container grid md:grid-cols-3 gap-8">
					<Card className="p-6">
						...
						<CardContent className="p-0 space-y-3 text-sm text-muted-foreground">
							<div>Maniini, Thohoyandou</div>
							<div>Limpopo, South Africa</div>
							<div className="font-medium text-foreground">Located in Maniini with easy access and parking.</div>
						</CardContent>
					</Card>
					<Card className="p-6">
						<CardHeader className="p-0 mb-4">
			...
			<section className="py-10 bg-muted/30">
				<div className="container">
					<h2 className="text-2xl md:text-3xl font-bold mb-8 text-center">What Makes Cabal Maniini Special</h2>
					<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
						...
						<Card className="p-6 text-center">
							...
							<CardContent className="p-0 text-sm text-muted-foreground">
								Easy access and parking for a smooth visit every time.
							</CardContent>
						</Card>
						<Card className="p-6 text-center">
							<CardHeader className="p-0 mb-4">
				...
				<div className="container">
					...
					<div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
						{[
							...
							{ src: "/alhola2.jpeg", alt: "Beverages" },
						].map((img) => (
